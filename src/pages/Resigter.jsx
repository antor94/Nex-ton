...
const Resigter = () => {
  ...
  const [againPassError, setAgainPassError] = useState('')
...
if(!againPass){
  setAgainPassError("Please enter your password again")
}
if(!userName){
          ...
          <form
            ...
            <div>
              ...
              <div className=" mt-[40px] lg:mt-[60px] mb-[24px]">
                <p className="text-[12px]  font-medium font-poppins text-red-500"> {userNameError}  </p>
                <h2 className="text-[16px] font-semibold font-poppins text-second dark:text-white mb-[8px] ">User-name</h2>   
            <input onChange={(e) => {setUserName(e.target.value) , setusernameError("") }}  className={`w-[312px] lg:w-[440px]  border rounded-[12px] py-[12px] pl-[16px]
                dark:text-white text-[14px] font-normal font-poppins border-primary dark:border-white text-[#4B5563] outline-none`}  type="text" placeholder="Us...."   />
              </div>
            ...
            <input onChange={(e) => {setEmail(e.target.value) , setEmailError("") }}  className={`w-[312px] lg:w-[440px]  border rounded-[12px] py-[12px] pl-[16px]  dark:text-white text-[14px] font-normal font-poppins border-primary dark:border-white text-[#4B5563] outline-none`}  type="email" placeholder="example@example.com"   />
              </div>
              ...
              <div className="mb-[24px] relative">
                ...
                <input onChange={(e)=>{setPass(e.target.value) , setPassError('')} }
                  className=' w-[312px] lg:w-[440px] border  rounded-[12px] py-[12px] pl-[16px] text-[14px] font-normal font-poppins dark:text-white dark:border-white text-[#4B5563] outline-none'
              ...
              {/* ---------------------- again password */}
                  <p className="text-[12px]  font-medium font-poppins text-red-500"> {againPassError}  </p>
              <div className="mb-[24px] relative">
                <h2 className="text-[16px] font-semibold font-poppins text-second dark:text-white mb-[8px] ">
                  Password (Again)
                </h2>
                <input onChange={(e)=>{setAgainPass(e.target.value) , setPassError('')} } 

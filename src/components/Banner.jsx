      ...
      >
        <div className="container">
          <div className="banner_text px-6">
            ...
            <Link
              to='/Sellercomponents'
              className=" w-[156px] h-[44px] lg:w-[198px] lg:h-[64px] bg-second flex justify-center items-center gap-[10px]
 rounded-full hover:scale-[1.1] duration-[.4s ] text-white text-[14px] lg:text-[16px] font-poppins font-medium"
            >
              Explore now{" "}
              <RiSearch2Line className="w-[16px] h-[16px] lg:w-[30px] lg:h-[20px]" />
            </Link>
          </div>
        </div>
      </section>

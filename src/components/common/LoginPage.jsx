...
const LoginPage = () => {
  return (
    <>
      <section id="login" className="mt-[40px] mb-[72px]">
        <div className="container">
          <BreadCrum breadContent={'Login'} />
          <div className="login_row w-[440px] h-[451px] px-[24px] lg:px-[548px]">
            <div className="mb-[60px] text-center ">
              <h1 className=" text-[24px] lg:text-[36px] text-center lg:padding-left: 160px;  padding-right: 91px; font-semibold font-poppins text-second dark:text-white ">
                Login
              </h1>
            </div>
            ...
            <div className="w-[312px] lg:w-[440px] flex items-center ">
              ...
              <p className="w-[36px] lg:px-[51px] text-[14px] font-medium font-poppins text-primary ">
                OR
              </p>
              <span className="w-[174px] border-[#F3F4F6] h-[1.6px] border inline-block"></span>
            </div>

            <h2 className="w-[237px] text-center flex justify-center text-[14px] lg:text-[16px] mt-[24px] ml-[38px] lg:ml-[120px] font-normal font-poppins text-primary ">
              New user?{" "}
              <Link to='/Resigter' className="text-[#0EA5E9]"> Create an account</Link>
            </h2>
          </div>
        </div>
      </section>
